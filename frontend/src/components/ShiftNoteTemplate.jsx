    ...
    <div style={{ background: "#fff", padding: 20, borderRadius: 8, marginBottom: 20 }}>
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <textarea
          ...
          onChange={(e) => {
            // only update committed text; strip interim on manual edit
            setInterimText("");
            setNotes(e.target.value);
          }}
          placeholder={SpeechRecognition ? 'Type here or click "Dictate" to speak your notes…' : "Type your notes here…"}
          rows={6}
          style={{ ...inputStyle, resize: "vertical", fontFamily: "inherit", fontSize: 14, lineHeight: 1.6, color: interimText ? "#374151" : "#111" }}
        />
        {isListening && (
